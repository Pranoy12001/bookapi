package com.pranoy.spring.config;
...
@ComponentScans(value= {
		@ComponentScan("com.pranoy.spring.dao"),
		@ComponentScan("com.pranoy.spring.service")
})
public class AppConfig {
	...
	public LocalSessionFactoryBean getSessionFactory() {
		...
		factoryBean.setPackagesToScan("com.pranoy.spring.model");
